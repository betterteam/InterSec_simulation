# coding:utf-8
# From 1230
# With Yang's instruction(in order to have more generality)
...
if __name__ == '__main__':
    ...
    vehicles_1N5_1W5 = []
    v = Vehicle()
    v.setPosition(Position(315, 0 + 20))
    v.setSpeed(Speed(0, 2))
    v.setSize(Size(10, 5))
    ...
    vehicles_1S2_1E2 = []
    v = Vehicle()
    v.setPosition(Position(285, 600 + 150))
    v.setSpeed(Speed(0, -2))
    v.setSize(Size(10, 5))
    ...
    vehicles_1S2_1W5 = []
    v = Vehicle()
    v.setPosition(Position(285, 600 + 250))
    v.setSpeed(Speed(0, -2))
    v.setSize(Size(5, 10))
    ...
    vehicles_1W2_1N2 = []
    v = Vehicle()
    v.setPosition(Position(0 - 300, 285))
    v.setSpeed(Speed(2, 0))
    v.setSize(Size(5, 10))
    ...
    vehicles_1E5_1S5 = []
    v = Vehicle()
    v.setPosition(Position(600 + 350, 315))
    v.setSpeed(Speed(-2, 0))
    v.setSize(Size(5, 10))
